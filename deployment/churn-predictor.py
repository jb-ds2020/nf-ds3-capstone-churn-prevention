...
# import data
print('Import Data')
filename = input("Please type the filename? (name + extension)")
PATH = os.path.abspath("scribt.ipynb").replace("scribt.ipynb", "")
print(f"Path: {PATH}")
print(f"Filename: {filename}")

# choose classifier
classifier = int(input("Please choose classifier: 1=Stacking, 2=Voting"))
...
predictions_df.to_csv(f"predictions-{classifier}.csv")
